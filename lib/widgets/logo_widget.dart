...
class LogoWidget extends StatelessWidget {
  ...
  const LogoWidget({super.key, this.size = 56, this.circleColor, this.iconColor, this.elevated = false});
  ...
  Widget build(BuildContext context) {
    ...
    final shadow = elevated ? [BoxShadow(color: Colors.black.withAlpha((0.12 * 255).round()), blurRadius: 12, offset: const Offset(0, 6))] : null;

    return Container(
      width: size,
      height: size,
      decoration: BoxDecoration(color: cColor, shape: BoxShape.circle, boxShadow: shadow),
